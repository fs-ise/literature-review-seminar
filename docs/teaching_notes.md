...
- [x] Print the [classification exercise sheet](../assets/classification-exercise.pdf) and the [summary](../exercises/typology/typology.pdf)
...
- [ ] Update the landing page to announce the dates for the upcoming semester (in a callout box).
